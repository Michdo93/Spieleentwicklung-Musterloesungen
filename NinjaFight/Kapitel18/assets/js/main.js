...
// und setzt es nur auf den gewuenschten.
...
function renderHighscoreList() {
  ...
  el.textContent = list.length === 0
    ? "Noch keine Eintraege - spiel eine Runde!"
...
// entspricht nextLevel()/restartGame() im vollstaendigen Spiel - hier
